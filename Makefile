server: server.o event_driver.o sock.o timer.o log.o ini.o channel.o event_handler.o
	g++ -Wall -o server server.o sock.o timer.o event_driver.o log.o ini.o channel.o event_handler.o -g -lrt
server.o:server.cpp
